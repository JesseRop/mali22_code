...
all_msc_bp_filt_seu_list_files <- Sys.glob("/lustre/scratch126/tol/teams/lawniczak/projects/malaria_single_cell/mali_field_runs/2022/data/cellranger_runs/Pf_all_genes/*/outs/filtered_feature_bc_matrix.h5")
...
all_msc_bp_filt_counts <- map(all_msc_bp_filt_seu_list_files, ~.x %>% 
  set_names(nm = (str_remove_all(.,'/lustre.*_all_genes/|/outs.*h5')))) %>% 
  unlist(., recursive = F) %>%  
  .[source_irods] %>%
...
all_msc_bp_raw_seu_list_files <- Sys.glob("/lustre/scratch126/tol/teams/lawniczak/projects/malaria_single_cell/mali_field_runs/2022/data/cellranger_runs/Pf_all_genes/*/outs/raw_feature_bc_matrix.h5")

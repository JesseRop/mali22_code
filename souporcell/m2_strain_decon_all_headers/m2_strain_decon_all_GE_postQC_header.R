...
# --sv_dir "pbulk_gtypes_GE_postQC" \
# --bam "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/MSC24/soupc_GE_postQC/*/parent/possorted_genome_bam.bam" \
# --bcodes "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/MSC*/pbulk_gtypes_GE_postQC/bcodes/minmap/stage_afm*/*tsv" \

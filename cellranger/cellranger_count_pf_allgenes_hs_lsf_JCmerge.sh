...
#BSUB -G team222
#BSUB -J crc_pf[14,20]
#BSUB -cwd /lustre/scratch126/tol/teams/lawniczak/projects/malaria_single_cell/mali_field_runs/2022/data/cellranger_runs/Pf_all_genes/
...
fastqdir=${mcadir}mali_field_runs/raw_data/10X_short_read_fastqs/RT822654_fastqs
# outdir=${mcadir}mali_field_runs/2022/data/cellranger_runs/Pf_all_genes
...
tsv=/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/raw/pf_solo_mixed_jcode_merge_decode_cellranger.tsv
sample_id=$(awk -F'\t' -v idx=$LSB_JOBINDEX 'NR==idx+1 {print $4}' "$tsv")

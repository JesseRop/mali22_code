...
source("/nfs/users/nfs_j/jr35/Mali2/mali22_code/2_cell_calling/plotting_fns_n_variables.R")
...
```{r, message=F, warning=F}
# asex_noM55_jcC_harmony <- CreateSeuratObject(counts = LayerData(asex_noM55_jcC_harmony, layer = "counts"), data = LayerData(asex_noM55_jcC_harmony, layer = "data"),  meta.data = asex_noM55_jcC_harmony@meta.data)
# 
# asex_noM55_jcC_harmony@reductions$umap.harmony_PC_man = asex_noM55_jcC_harmony@reductions$umap.harmony_PC_man
# 
# asex_noM55_jcC_harmony
...
seu_cols_base <- brewer.pal(12, name = "Set3") %>% set_names(c(0:11))
...
```{r, warning=FALSE, message=FALSE, fig.width=3, fig.height=3}
DimPlot(asex_noM55_jcC_harmony, label = F, reduction = "umap.harmony_PC_man", dims = c(1,3), group.by = "harmony_clusters_fine_erings", label.size = 6, label.box = F, pt.size = 0.001) +
  scale_color_manual(values = seu_cols) +
  scale_fill_manual(values = seu_cols) +
  theme_classic() +
  labs(title = "", x = "UMAP1", y= "UMAP2") +
...
asex_noM55_jcC_harmony_light_figs <- asex_noM55_jcC_harmony@meta.data %>%
  ...
  AddMetaData(asex_noM55_jcC_harmony, .)
...
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1222600"), reduction = "umap.harmony_PC_man", order = T, ncol = 1)+
  theme_classic() +
  labs(title = "", x = "UMAP1", y= "UMAP2") +
...
```{r, warning=FALSE, message=FALSE, fig.width=2.5, fig.height=4}
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1222600"), reduction = "umap.harmony_PC_man", order = T, ncol = 1, dims = c(1,3))+
  theme_classic() +
...
# ap2g, surf1.2, gexp05
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1222600", "PF3D7-0113600", "PF3D7-1102500"), reduction = "umap.harmony_PC_man", order = T, ncol = 3)

```

```{r, warning=FALSE, message=FALSE, fig.width=9, fig.height=3}
# antisense gdv1 , gdv1
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-0935390", "PF3D7-0935400"), reduction = "umap.harmony_PC_man", order = T, ncol = 2, pt.size = 0.5)
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-0935390", "PF3D7-0935400"), reduction = "umap.harmony_PC_man", order = T, ncol = 2, pt.size = 0.5, dims = c(1,3))
...
```{r, warning=FALSE, message=FALSE, fig.width=9, fig.height=3}
# antisense gdv1 , gdv1
gdv1_asgdv1 <- FetchData(object = asex_noM55_jcC_harmony, layer = "data", vars = c("PF3D7-0935400", "PF3D7-0935390"))
gdv1_asgdv1_mdata_umap2 <- cbind(asex_noM55_jcC_harmony@meta.data, asex_noM55_jcC_harmony@reductions$umap@cell.embeddings, gdv1_asgdv1)
...
```{r, warning=FALSE, message=FALSE}
# CBP2
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1301700"), reduction = "umap.harmony_PC_man")
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1301700"), reduction = "umap.harmony_PC_man", dims = c(1,3))
...
```{r, warning=FALSE, message=FALSE}
# PTP4, PF3D7-0406500
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-0730900"), reduction = "umap.harmony_PC_man", dims = c(1,3))
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-0406500"), reduction = "umap.harmony_PC_man", dims = c(1,3))

```

```{r, warning=FALSE, message=FALSE, fig.width=9, fig.height=3}
# CBP2
VlnPlot(asex_noM55_jcC_harmony, features = c("PF3D7-1301700"), group.by = "harmony_clusters_fine_erings", pt.size = 0)
```
```{r}
asex_noM55_jcC_harmony@meta.data %>% ggplot(aes(y = nFeature_RNA, x = seurat_clusters)) + geom_violin() + geom_hline(yintercept = 300)
asex_noM55_jcC_harmony@meta.data %>% ggplot(aes(y = nCount_RNA, x = seurat_clusters)) + geom_violin() + geom_hline(yintercept = 1000)

```

```{r, warning=FALSE, message=FALSE, fig.width=9, fig.height=3}
FeaturePlot(asex_noM55_jcC_harmony, features = c("PF3D7-1222600", "PF3D7-0113600", "PF3D7-1102500"), reduction = "umap.harmony_PC_man", order = T, ncol = 3, dims = c(1,3))

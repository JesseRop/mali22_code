...
```{r, eval=T}
saveRDS(all_jcC_seu_scvi_stg_noM55_afm_cln_no_cluster_misplaced_cells, paste0(save_dir_integrated_scvi_cleanup, 'all_jcC_seu_scvi_stg_noM55_afm_cln_no_cluster_misplaced_cells.RDS'))

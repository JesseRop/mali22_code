...
# v3_m2_asex_harmony_ss_res_fld_pt <- readRDS("data/processed/Pf/m2_all/all_msc_qcd_anotd_c_asex_mrg.RDS")
# m2_asex_raw_jcC_mrg <- readRDS("data/processed/Pf/m2_all/all_msc_qcd_anotd_c_asex_mrg.RDS")
# m2_asex_raw_jcO_mrg <- readRDS("data/processed/Pf/m2_all/all_msc_qcd_anotd_orig_asex_mrg.RDS")
m2_asex_raw_jcC_mrg <- readRDS("data/processed/Pf/m2_all/all_msc_qcd_anotd_c_asex_mrg3.RDS")
m2_asex_raw_jcO_mrg <- readRDS("data/processed/Pf/m2_all/all_msc_qcd_anotd_orig_asex_mrg3.RDS")
...
```{r}
m2_asex_raw_mrg <- list(m2_asex_raw_jcC_mrg, m2_asex_raw_jcO_mrg) %>% set_names(c("jcC", "jcO"))
...
# --input_seu "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/m2_all/v3_m2_asex_cr_filt_*{jcC,jcO}.RDS" \
# --hvg 400 --cluster_resoln 0.1 --cl_nm "seurat_clusters" --integrtd_pc30 "no" \
# --ncores "6" --mem "100 GB" --run_time="55.min" \
...
# --input_seu "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/m2_all/v3_m2_asex_cr_filt_*{jcC,jcO}_norm.RDS" \
# --mthd_nm "harmony_PC_man" --cluster_resoln 0.5 --intgrtn_pc 8 --integrtd_pc_man "yes" \
# --ncores "8" --mem "100 GB" --run_time="1.hour" \
...
v3_m2_asex_cr_filt_norm_harmony2 <- readRDS("data/processed/Pf/m2_all/v3_m2_asex_cr_filt_noM55_jcC_3_norm2_harmony_PC_man.RDS") 
v3_m2_asex_cr_filt_norm_harmony2 <- list(v3_m2_asex_cr_filt_norm_harmony2)
```

```{r, warning=FALSE, message=FALSE, eval=F}
map(v3_m2_asex_cr_filt_norm_harmony2, ~DimPlot(.x, label = T, group.by = "stage", reduction = "umap.harmony_PC_man") + scale_color_manual(values = sp_col_new))
```

```{r, warning=FALSE, message=FALSE, eval=F}
map(v3_m2_asex_cr_filt_norm_harmony['noM55_jcC'], ~DimPlot(.x, label = T, group.by = "stage", reduction = "umap.harmony_PC_man") + scale_color_manual(values = sp_col_new))
```


```{r, warning=FALSE, message=FALSE, eval=F}
all_equal(v3_m2_asex_cr_filt_norm_harmony2[[1]]@reductions$umap.harmony_PC_man@cell.embeddings %>% data.frame(), v3_m2_asex_cr_filt_norm_harmony[['noM55_jcC']]@reductions$umap.harmony_PC_man@cell.embeddings %>% data.frame())
```

##########START# Run the same object twice through integration UMAP clustering to ensure seed is working - only needed for testing this ###############
```{r, message=F, warning=F, eval=F}
v3_m2_asex_cr_filt_norm_harmony_bckup <- readRDS("data/processed/Pf/m2_all/v3_m2_asex_cr_filt_noM55_jcC_3_bckup_norm_harmony_PC_man.RDS") 
v3_m2_asex_cr_filt_norm_harmony_bckup <- list(v3_m2_asex_cr_filt_norm_harmony_bckup)
```

```{r, message=F, warning=F, eval=F}
v3_m2_asex_cr_filt_norm_harmony_bckup2 <- readRDS("data/processed/Pf/m2_all/v3_m2_asex_cr_filt_noM55_jcC_3_bckup2_norm_harmony_PC_man.RDS") 
v3_m2_asex_cr_filt_norm_harmony_bckup2 <- list(v3_m2_asex_cr_filt_norm_harmony_bckup2)
```


```{r, warning=FALSE, message=FALSE, eval=F}
map(v3_m2_asex_cr_filt_norm_harmony_bckup, ~DimPlot(.x, label = T, group.by = "stage", reduction = "umap.harmony_PC_man") + scale_color_manual(values = sp_col_new))

```

```{r, warning=FALSE, message=FALSE, eval=F}
map(v3_m2_asex_cr_filt_norm_harmony_bckup2, ~DimPlot(.x, label = T, group.by = "stage", reduction = "umap.harmony_PC_man") + scale_color_manual(values = sp_col_new))
```

```{r, warning=FALSE, message=FALSE, eval=F}
all_equal(v3_m2_asex_cr_filt_norm_harmony_bckup[[1]]@reductions$umap.unintegrated@cell.embeddings %>% data.frame(), v3_m2_asex_cr_filt_norm_harmony_bckup2[[1]]@reductions$umap.unintegrated@cell.embeddings %>% data.frame())
```
##########END# Run the same object twice through integration UMAP clustering to ensure seed is working - only needed for testing this ###############

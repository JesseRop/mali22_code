...
fm_leiden_w_donors_norm_harmony_jnd <- fm_leiden_w_donors_norm_harmony_jnd[c("all.fLE", "all.m_mLE", "all.m", "w.5.f_fLE", "w.5.f", "w.7.f", "w.7.m")]
...
start_clusters <- c(1, 0, 0, 2, 1, 0, 0)
end_clusters <- c(0, 1, 1, 0, 0, 1, 1)

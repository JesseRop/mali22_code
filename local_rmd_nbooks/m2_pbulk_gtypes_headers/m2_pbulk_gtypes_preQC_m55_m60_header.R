...
gtyp_step = "pbulk_gtypes_preQC_m55_m60"
...
sv_dir = "pbulk_gtypes_preQC_final_m55_m60"
...
# --bcodes "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/{MSC55,MSC60}/pbulk_gtypes_preQC/bcodes/*/stage_afm*/*tsv" \

...
# for (i in 32:33) {
  ...
  system(paste0('mkdir -p /Users/jr35/Google\\ Drive/My\\ Drive/PHD_documents/malaria_phd/Mali2/data/processed/Pf/', sample_name[i]))
...
list.files("data/raw/", pattern = "filtered_feature_bc_matrix.h5$", full.names = T, recursive = T, include.dirs = T) %>% 
  set_names(nm = (str_remove_all(.,'data/raw//|/Pf.*'))) %>% 
  .[sample_name] %>%

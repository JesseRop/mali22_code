...
```{r, results='asis'}
# cat('## Visualize field parasites {.tabset}   \n')
#PF3D7_0208900 - p230p - male marker 
#PF3D7_0109100 - ccp5 - female marker
#PF3D7_0935900 - rex1 - asexual marker
#PF3D7_0406200 - pfs16 - gam marker

all_msc_nosct_supx_4_dblt  %>% 
  purrr::imap(.,~{
    # create tabset for each group 
    cat('##### ',.y,'   \n')
    p <- FeaturePlot(., features = c("PF3D7-0935900","PF3D7-0406200", "PF3D7-0208900", "PF3D7-0109100"), dims = c(1,2))
    print(p)
    cat('\n')
    cat("\n")
  })
...
#       dplyr::rename_with(.fn = ~paste0("scf_",., ..2), .cols = everything()) %>% 

...
msc_w_cln_strns_mdata <- msc_w_cln_strns %>% 
  ...
  mutate(bcode_don = paste0(donor, "_", bcode),
         stage_ag = ifelse(stage_c == "Asexual", "Asexual", "Gametocytes"))  
...
msc_w_cln_strns_w_don_mdata %>%
  ...
  mutate(Stage_ag = factor(stage_ag, levels = c("Gametocytes", "Asexual")),
...
DimPlot(m2_seu_norm_harmony, reduction = "umap.harmony", group.by = c("stage"), pt.size = 1, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)

```

```{r}

DimPlot(m2_seu_norm_harmony, reduction = "umap.harmony", group.by = c("donor"), pt.size = 1, dims = c(1,2), raster = F)

```

```{r, fig.width= 10, fig.height=4}

DimPlot(m2_seu_norm_harmony, reduction = "umap.harmony", group.by = c("stage"), split.by = "groups", pt.size = 0.1, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)

```


```{r}
DimPlot(m2_seu_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), pt.size = 0.1, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
```


```{r, fig.width= 10, fig.height=4}

DimPlot(m2_seu_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), split.by = "groups", pt.size = 0.1, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
...
DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), pt.size = 1, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)

```

```{r}

DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("donor"), pt.size = 1, dims = c(1,2), raster = F)

```

```{r, fig.width= 8.5, fig.height=4}

DimPlot(m2_seu_no_M12_norm_harmony, reduction = "umap.harmony", group.by = c("stage"), split.by = "groups", pt.size = 0.01, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) + theme_void() + 
...
DimPlot(m2_seu_no_M12_norm_harmony, reduction = "umap.harmony", group.by = c("stage"), pt.size = 0.01, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)+ theme_void() + 
  theme(text = element_text(size = 20, face ="bold"),
        title = element_blank())
...
DimPlot(m2_seu_no_M12_norm_harmony, reduction = "umap.harmony", group.by = c("stage"), pt.size = 0.01, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)

```

```{r}
DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), pt.size = 0.01, dims = c(1,3), raster = F) + scale_color_manual(values = sp_fld_colors)

DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), pt.size = 0.01, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) + theme_void() + 
  theme(text = element_text(size = 20, face ="bold"),
        title = element_blank())
```
...
```{r, fig.width= 8.5, fig.height=4}
DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), split.by = "groups", pt.size = 0.1, dims = c(1,3), raster = F) + scale_color_manual(values = sp_fld_colors)

DimPlot(m2_seu_no_M12_norm_harmony, reduction = "integrated.harmony", group.by = c("stage"), split.by = "groups", pt.size = 0.01, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) + theme_void() + 
  theme(text = element_text(size = 20, face ="bold"),
        title = element_blank())
...
plot_ly(data = data.frame(m2_seu_no_M12_norm_harmony@reductions[["umap.harmony"]]@cell.embeddings),
        x = ~umapharmony_1, y = ~umapharmony_2, z = ~umapharmony_3,
...
DimPlot(m2_seu_no_M12_norm, reduction = "pca", group.by = "stage", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) 

DimPlot(m2_seu_no_M12_norm, reduction = "umap.unintegrated", group.by = "stage", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
```

```{r, fig.width=8, fig.height=6}
# visualize by batch and cell type annotation

DimPlot(m2_seu_no_M12_norm, reduction = "umap.unintegrated", group.by = "stage", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) + theme(legend.position = "bottom") + guides(color = guide_legend(nrow = 3, override.aes = list(size =3), title = "Stage", title.position = "top"))
```
...
```{r, fig.width= 10, fig.height=4}
DimPlot(m2_seu_no_M12_norm, reduction = "umap.unintegrated", group.by = "stage", split.by = "groups", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
...
DimPlot(m2_seu_norm, reduction = "umap.unintegrated", group.by = "stage", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
```

```{r, fig.width=8, fig.height=6}
# visualize by batch and cell type annotation

DimPlot(m2_seu_norm, reduction = "umap.unintegrated", group.by = "stage", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors) + theme(legend.position = "bottom") + guides(color = guide_legend(nrow = 3, override.aes = list(size =3), title = "Stage", title.position = "top"))
```
...
```{r, fig.width= 10, fig.height=4}
DimPlot(m2_seu_norm, reduction = "umap.unintegrated", group.by = "stage", split.by = "groups", label = F, dims = c(1,2), raster = F) + scale_color_manual(values = sp_fld_colors)
...
msc_w_cln_strns_mdata %>% group_by(donor) %>% mutate(n_strains = n_distinct(strain), n_strains2 = n_distinct(StrainDon)) %>% distinct(donor, Symptomatic, n_strains, n_strains2) %>% 
...
test_result <- map(paired_data, ~{wilcox.test(.x$Asexual, .x$Gametocytes, paired = TRUE)})
...
map2(tbl_strn_list, test_result, ~{.x %>%
  ...
  theme_classic() + 
  geom_signif(
    comparisons = list(c("Asexual", "Gametocytes")),
...
```{r}
DimPlot(v3_m2_asex_harmony_res, pt.size = 0.4, reduction = "umap.harmony", group.by = "harmony_clusters", label = T, dims = c(1,2))
```
...
DimPlot(EF_V3_ref[, EF_V3_ref@meta.data$stagenew == "asexuals"], reduction = "umap", group.by = "StageFL_ND", label = F, dims = c(2,3)) + scale_color_manual(values = sp_fld_colors)
...
DimPlot(v3_m2_asex_harmony_res, reduction = "umap.harmony", group.by = "stage", label = F, dims = c(1,2)) + scale_color_manual(values = sp_fld_colors) + 
  theme(axis.text = element_text(size = 14),
        axis.title = element_text(size = 20))

DimPlot(v3_m2_asex_harmony_res, reduction = "umap.harmony", group.by = "StageFL_ND", label = F, dims = c(1,2)) + scale_color_manual(values = sp_fld_colors) + 
  theme(axis.text = element_text(size = 14),
        axis.title = element_text(size = 20))
...
DimPlot(v3_m2_asex_harmony_res, reduction = "umap.harmony", split.by = "dsetC", group.by = "harmony_clusters", label = T, dims = c(1,2)) + theme(legend.position = "none") +
...
DimPlot(v3_m2_asex_harmony_res, reduction = "umap.harmony", split.by = "dsetC", group.by = "harmony_clusters_ss", label = T, dims = c(1,2)) + theme(legend.position = "none") +
  guides(color = guide_legend(title.position = "top", nrow =2, override.aes = list(size = 2))) 
```
...
DimPlot(v3_m2_asex_harmony_res, reduction = "integrated.harmony", split.by = "dsetC", group.by = "harmony_clusters_ss", label = T, dims = c(1,2)) + theme(legend.position = "none") +
  guides(color = guide_legend(title.position = "top", nrow =2, override.aes = list(size = 2))) 
```
...
```{r, fig.width=10, fig.height=4}
# visualize by batch and cell type annotation
DimPlot(v3_m2_asex_harmony_res, reduction = "integrated.harmony", split.by = "dsetC", group.by = "harmony_clusters_ss", label = T, dims = c(1,3)) + theme(legend.position = "none") +
  guides(color = guide_legend(title.position = "top", nrow =2, override.aes = list(size = 2))) 
```

```{r, fig.width=10, fig.height=4}
# visualize by batch and cell type annotation
DimPlot(v3_m2_asex_harmony_res, reduction = "integrated.harmony", split.by = "dsetC", group.by = "harmony_clusters_ss", label = T, dims = c(2,3)) + theme(legend.position = "none") +
  guides(color = guide_legend(title.position = "top", nrow =2, override.aes = list(size = 2))) 
```
...
plot_ly(data = data.frame(v3_m2_asex_harmony_res@reductions[["integrated.harmony"]]@cell.embeddings),
...
DimPlot(v3_m2_asex_harmony_res_fld, pt.size = 0.4, reduction = "umap.harmony", group.by = "harmony_clusters_ss", label = T, dims = c(1,2), split.by = "dsetC") + 
...
```{r, fig.width=7.5, fig.height=4.5 }
DimPlot(v3_m2_asex_harmony_res_fld, pt.size = 0.4, reduction = "integrated.harmony", group.by = "harmony_clusters_ss", label = T, dims = c(1,2), split.by = "dsetC") + 
  theme(text = element_text(size = 18),
        axis.text = element_text(size = 14)
        )
...
```{r, fig.width=7.5, fig.height=4.5 }
DimPlot(v3_m2_asex_harmony_res_fld, pt.size = 0.4, reduction = "integrated.harmony", group.by = "harmony_clusters_ss", label = T, dims = c(2,3), split.by = "dsetC") + 
  theme(text = element_text(size = 18),
        axis.text = element_text(size = 14)
        )
...
DimPlot(v3_m2_asex_harmony_res_fld_pt, reduction = "umap.harmony", group.by = c("StageFL_ND"), label = F) + scale_color_manual(values = sp_fld_colors) + 
  theme(text = element_text(size = 18),
        axis.text = element_text(size = 14)
        )
...
FeaturePlot(v3_m2_asex_harmony_res_fld_pt, reduction = "umap.harmony", features = "pseudotime") + 
  theme(text = element_text(size = 18),
        axis.text = element_text(size = 14)
        )
...
# visualize by batch and cell type annotation
DimPlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", group.by = c("StageFL"), label = F)
FeaturePlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", features = "pseudotime", label = F)
FeaturePlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", features = "pseudotime", label = F, dims = c(2,3))
DimPlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", group.by = c("harmony_clusters_ss"), label = T)
DimPlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", group.by = c("harmony_clusters_ss"), label = T, dims = c(2,3))
DimPlot(v3_m2_asex_harmony_res_fld_pt, reduction = "integrated.harmony", group.by = c("StageFL_ND"), label = F, dims = c(2,3)) + scale_color_manual(values = sp_fld_colors)
...
plot_ly(data = data.frame(v3_m2_asex_harmony_res_fld_pt@reductions[["integrated.harmony"]]@cell.embeddings),
        x = ~harmony_1, y = ~harmony_2, z = ~harmony_3,

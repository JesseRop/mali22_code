...
soup_dir = "soupc"
sv_dir = "pbulk_gtypes_preQC_m55_m60"
...
# --sv_dir "pbulk_gtypes_preQC_m55_m60" \
# --bam "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/{MSC55,MSC60}/soupc/*/parent/possorted_genome_bam.bam" \
# --bcodes "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/{MSC55,MSC60}/pbulk_gtypes_preQC_m55_m60/bcodes/*/stage_afm*/*tsv" \
...
# --sv_dir "pbulk_gtypes_preQC_m55_m60" \
# --bam "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/{MSC55,MSC60}/soupc/*/parent/possorted_genome_bam.bam" \
# --bcodes "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/{MSC55,MSC60}/pbulk_gtypes_preQC_m55_m60/bcodes/minmap/stage_afm*/*tsv" \
# --odir "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/data/processed/Pf/" \
# --scrpt "/nfs/users/nfs_j/jr35/multipurpose_scripts/cr_subset_bam_linux.sh" \
# --save_bam_sset true\
# --ref  "/lustre/scratch126/tol/teams/lawniczak/projects/malaria_single_cell/mali_field_runs/2022/data/references_for_souporcell/PlasmoDB-66_Pfalciparum3D7_Genome.fasta"

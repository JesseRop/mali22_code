...
```{r}
v3_m2_asex_harmony_ss_res_fld_pt_list <- SplitObject(v3_m2_asex_harmony_ss_res_fld_pt, split.by = "donor")
```
...
v3_m2_asex_cr_filt_no_M55 <- v3_m2_asex_cr_filt[, !v3_m2_asex_cr_filt@meta.data$donor == "MSC55"]
```

```{r}
## remove any donor with less than 100 cells and donor MSC55
saveRDS(v3_m2_asex_cr_filt_no_M55, "data/processed/Pf/m2_all/v3_m2_asex_cr_filt_no_M55.RDS")
```

...
```{r}
## remove lab and M12
v3_m2_asex_cr_filt <- m2_asex_raw_mrg[, !m2_asex_raw_mrg@meta.data$dset_labmrg %in% c("Lab", "MSC12")]
```
...
v3_m2_asex_cr_filt_noM55 <- v3_m2_asex_cr_filt[, !v3_m2_asex_cr_filt@meta.data$donor == "MSC55"]
```

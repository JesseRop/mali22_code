...
donor_sk21_summary <- donor_sk21_summary %>% rename_all(., ~str_replace_all(.,c("\\["="_", "\\]"="", " "="", "-"="",  "\\/"="_", "º"=""))) %>% filter(!is.na(Sample_Name))
```
...
tseq_de_hmap <- function(tseq = m2_asex_ref_ts_sce_ub_de[[1]], de_tbl , pnts = 30, rnames = F, comp_grps){

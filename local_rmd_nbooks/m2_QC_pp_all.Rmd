...
all_msc <- readRDS("data/processed/Pf/all_msc_anotd_preQC.RDS") %>% .[sample_id_lst]
```
...
vp_fn(seu_lst = rep(all_msc, 2), gnc_lst = lc_lst, ugnc_lst = uc_lst, seu_thresh = 100000000, ftr = c(nf_lst, nc_lst), grp = NULL, ptsz = 0.01, nrws = 4)
```

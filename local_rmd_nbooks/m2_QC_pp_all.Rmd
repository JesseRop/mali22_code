...
#   map2(., sample_name_nms, ~ CreateSeuratObject(.x, project = paste0(.y, ".mrna"))) %>% 
...
all_msc_anotd_ysct <- list.files("data/processed/", pattern = "seu_norm_anotd_sct.RDS$", full.names = T, recursive = T, include.dirs = T) %>% 

...
```{r, results='asis'}
# cat('## Visualize field parasites {.tabset}   \n')
list(all_msc_anotd_preQC, mt_filt1, sample_id_lst, names(all_msc_anotd_preQC))  %>% 
  purrr::pmap(.,~{
...
# soupo_kselect_list_pp <-  readRDS("data/processed/Pf/strn_c_new_mdata_m22_min_qcd.RDS") %>% .[paste(sample_id_lst, algn_nm, sep = "_")]

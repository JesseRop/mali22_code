...
# --mthd_nm "harmony_PC_man" --cluster_resoln 0.3 --intgrtn_pc 86 --integrtd_pc_man "yes" \
...
```{r, warning=FALSE, message=FALSE}
imap(fm_leiden_w_donors_norm_harmony_jnd, ~saveRDS(., paste0("data/processed/Pf/m2_all/fm_leiden_w_donors_", .y,"_norm_harmony_jnd.RDS")))

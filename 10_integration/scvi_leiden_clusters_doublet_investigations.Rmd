...
all_jcC_scvi_noM55_no_cluster_misplaced_cells <- readRDS(paste0(read_dir_integration, 'all_jcC_seu_scvi_stg_noM55_afm_cln_no_cluster_misplaced_cells.RDS'))
...
```{r, eval=T}
saveRDS(wilcox_scviLeiden_markers_4DbtDetection_anot, paste0(save_dir_integration, 'wilcox_scviLeiden_markers_4DbtDetection_anot.RDS'))

```

```{r, eval=T}
## Read in DE results to avoid recalculating
wilcox_scviLeiden_markers_4DbtDetection_anot <- readRDS(paste0(save_dir_integration, 'wilcox_scviLeiden_markers_4DbtDetection_anot.RDS'))
...
saveRDS(all_jcC_seu_scvi_stg_noM55_afm_ActivAsexDbts, paste0(save_dir_integration, "all_jcC_seu_scvi_stg_noM55_afm_ActivAsexDbts.RDS"))
saveRDS(all_jcC_seu_scvi_stg_noM55_afm_ActivAsexDbts[[1]], paste0(save_dir_integration, "all_jcC_seu_scvi_stg_noM55_ActivAsexDbts.RDS"))

```

```{r}
saveRDS(tbl_umap_gn_asx_hires_stages, paste0(save_dir_integration, "tbl_umap_gn_asx_hires_stages.RDS"))
...
```{r}
# save the overal object with activated+asex doublet annotation
saveRDS(all_jcC_seu_scvi_noM55_afm_cln, paste0(save_dir_integration, "all_jcC_seu_scvi_noM55_afm_cln.RDS"))

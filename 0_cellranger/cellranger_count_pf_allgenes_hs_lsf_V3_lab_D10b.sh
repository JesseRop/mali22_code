...
fastqdir=${mcadir}mali_field_runs/raw_data/10X_short_read_fastqs/31359
...
tsv=/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/v3_atlas/data/raw/v3_atlas_decode_cellranger_D10b.tsv
sample_id=$(awk -F'\t' -v idx=$LSB_JOBINDEX 'NR==idx+1 {print $3}' "$tsv")

...
# Save the sankey plotting table for plotting in a separate script incase needed for publication
saveRDS(cr_cbender_mdata_hmnz_syst_snky_pfumi, "data/processed/Pf/m2_all/cell_calling_plotting/cr_cbender_mdata_hmnz_syst_snky_pfumi.RDS")

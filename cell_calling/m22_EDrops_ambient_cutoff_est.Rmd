...
```{r, message=F, warning=F, eval=T, fig.height=25, fig.width=10}
##Read edrops results matrices
map(c("knee", "inflection"), ~{

    bcranks_cutoff_plot_fn(dset = all_bcrank_mrg, hline_droplets = "umi_counts_cutoff_total_droplets_", hline_droplets_lab = "umi_cutoff_droplets:", hline_cells = "umi_counts_cutoff_cell_estimate_", hline_cells_lab = "umi_cutoff_cells:", line_part = .x)
